...
export const Hero = () => {
  ...
  return (
    ...
    >
      ...
      >
        <p className="mb-2 text-3xl font-light">
          <span className="font-medium">Priyanshu</span> Raj Anand
        </p>
        <p className="mb-8 text-center text-s font-light text-[--color-text]">
          Presents
          <br />
        </p>

        <h1 className="mb-12 text-center font-heading text-7xl leading-[1]">
        Image Animation
          <br />
          on Scroll
        </h1>

        <a href="/" className="flex items-center text-lg text-[--color-primary]">
         GET STARTED
        </a>
      </motion.div>
    </motion.section>
